...
class FirebaseController extends Controller
{
    ...
    public function getRealtimeData()
    {
        /** 
         * ================================
         * 1. Coba ambil REALTIME dari Firebase
         * ================================
         */
        ...
        if (!empty($raw)) {
            ...
            // Pastikan bisa handle array atau stdClass
            $data = is_object($raw) ? (array) $raw : $raw;

            return response()->json([
                'device_id' => $data['device_id'] ?? $data['deviceId'] ?? 0,
                'voltage'   => (float) ($data['voltage'] ?? $data['voltage_v'] ?? 0),
                'amperage'  => (float) ($data['amperage'] ?? $data['current'] ?? 0),
                'watt'      => (float) ($data['watt'] ?? $data['power'] ?? 0),
        ...
        /**
         * ================================
         * 2. Firebase kosong → fallback ke MySQL
         * ================================
         */
        ...
        if ($latest) {
            return response()->json([
                ...
                'timestamp' => $latest->timestamp instanceof \Carbon\Carbon
        ...
        /**
         * ================================
         * 3. Semua kosong → fallback default 0
         * ================================
         */
        return response()->json([
            'device_id' => 0,

...
<body class="bg-[#E1DFEC] text-gray-900 font-sans">
    ...
    <div class="bg-[#E1DFEC] mx-auto px-2 sm:px-4">
        <div class="container mx-auto flex flex-col md:flex-row gap-4 py-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 items-stretch">
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <div class="bg-white rounded-3xl shadow-md p-4 flex flex-col justify-between flex-1">
                            <h2 class="text-sm font-semibold text-gray-500">Terakhir pengisian daya</h2>
                        ...
                        <!-- Sensor 2 - Uncomment untuk menambah sensor -->

                        <div class="bg-white rounded-3xl shadow-md p-4 flex flex-col justify-between flex-1">
                            <h2 class="text-sm font-semibold text-gray-500">Terakhir pengisian daya</h2>
                            <div class="flex justify-between items-center mt-auto">
                                <p class="text-xl text-gray-800 mt-1 last-charge-date"><span>30</span> Wh/jam</p>
                                <img src="{{ asset('images/icon_kWh.png') }}" alt="icon meter" class="w-10 h-10">
                            </div>
                        </div>


                        <!-- Sensor 3 - Uncomment untuk menambah sensor -->
                        <!--
            <div class="bg-white rounded-3xl shadow-md p-6 flex flex-col justify-between flex-1">
                <h3 class="text-lg font-bold text-gray-800 mb-4">Sensor 3</h3>
                <div class="flex justify-between items-center mt-auto">
                    <p class="text-4xl font-bold text-gray-900">45 W</p>
                    <img src="{{ asset('images/icon_kWh.png') }}" alt="icon meter" class="w-10 h-10">
                </div>
            </div>
            -->
            ...
            <div class="bg-[#d5dbea] shadow-sm rounded-3xl p-4 sm:p-4 flex-1">
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-3 items-stretch">
                    <!-- Card penggunaan energi -->
                    <div class="flex flex-col gap-2">
                        <h2 class="text-lg font-semibold text-gray-800">Penggunaan energi</h2>
                        <div class="flex flex-row gap-3 justify-between flex-1">

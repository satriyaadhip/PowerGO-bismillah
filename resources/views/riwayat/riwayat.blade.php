            ...
            <div class="overflow-x-auto">
                <table class="w-full">
                    <thead class="bg-gray-50 border-b">
                        <tr>
                            <th
                                class="px-4 py-3 text-left text-xs font-semibold text-gray-600 tracking-wider">
                                No.</th>
                            <th
                                class="px-4 py-3 text-left text-xs font-semibold text-gray-600 tracking-wider">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-4 py-3 text-sm font-medium">Rp500.000</td>
                        </tr>
                        <tr class="hover:bg-gray-50 transition-colors">
                            <td class="px-4 py-3 text-sm">2.</td>
                            <td class="px-4 py-3 text-sm">Alfamart</td>
                            <td class="px-4 py-3 text-sm">28 September 2025</td>
                            <td class="px-4 py-3 text-sm font-medium">Rp750.000</td>
                        </tr>
                        <tr class="hover:bg-gray-50 transition-colors">
                            <td class="px-4 py-3 text-sm">3.</td>
                            <td class="px-4 py-3 text-sm">Indomaret</td>
                            <td class="px-4 py-3 text-sm">25 September 2025</td>
                            <td class="px-4 py-3 text-sm font-medium">Rp320.000</td>
                        </tr>
                    </tbody>
                </table>
            </div>

    ...
    <div class="container mx-auto flex flex-col md:flex-row gap-4 py-2">
        ...
        <div class="flex-1">
            ...
            <div class="bg-white rounded-3xl shadow-lg p-6 mb-4">
                ...
                <div id="hourly-chart" class="w-full h-[300px]">
        ...
        <div class="flex-1">
            ...
            <div class="bg-white rounded-3xl shadow-lg p-6 mb-4">
                ...
                <div id="weekly-chart" class="w-full h-[350px]">
                    <!-- Chart akan di-render di sini -->
                </div>
            </div>

                    ...
                    <table class="w-full">
                        ...
                        @foreach ($hourlyData as $data)
                            <tr class="border-b border-gray-100 hover:bg-gray-50">
                                ...
                                <td class="py-3 px-4 text-right font-semibold">{{ $data['watt'] }}</td>
                                <td class="py-3 px-4 text-right">{{ number_format($data['kwh'], 2) }}</td>
                                <td class="py-3 px-4 text-right">{{ number_format($data['cost'], 0, ',', '.') }}</td>
                            </tr>
                        @endforeach
                    ...
                    <table class="w-full">
                        ...
                        @forelse ($weeklyData as $day)
                            <tr class="border-b border-gray-100 hover:bg-gray-50">
                                ...
                                <td class="py-3 px-4 text-right font-semibold">{{ number_format($day['avg_watt'], 2) }}</td>
                                <td class="py-3 px-4 text-right">{{ number_format($day['kwh'], 2) }}</td>
                                <td class="py-3 px-4 text-right">{{ number_format($day['cost'], 0, ',', '.') }}</td>
                            </tr>
                        @empty
                            <tr>
    ...
    new Chart(document.getElementById('weekly-chart'), {
        ...
        options: {
            ...
            scales: {
                ...
                y1: { position: 'right', title: { display: true, text: 'Biaya' }, grid: { drawOnChartArea: false }},
            }
        }
    });
</script>
